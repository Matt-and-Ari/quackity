...
import { ChannelEmptyState, DmEmptyState } from "./WorkspaceGlyphs";
      ...
      >
        {props.isMessagesLoading ? (
          ...
          <>
                    ...
                    <div key={message.id}>
                      ...
                      <MessageCard
                        ...
                        onOpenReactionMenu={(anchor) =>
                          props.onOpenReactionMenu(anchor, message.id)
                        }
            ...
            {props.dmInfo ? (
              <DmEmptyState
                displayName={props.dmInfo.displayName}
                imageUrl={props.dmInfo.imageUrl}
                isSelf={props.dmInfo.isSelf}
                role={props.dmInfo.role}
              />
            ) : visibleMessages.length === 0 ? (
