...
Write a PR description that summarizes all changes in the current branch compared to `main`, grouped into clear sections with bullet lists.

## Goal

Produce a concise, accurate PR description covering everything introduced by this branch against `main`.

## Required behavior

- Compare `main...HEAD` as the source of truth.
...
- Do not cap bullet count; cover every meaningful change in `main...HEAD`.
